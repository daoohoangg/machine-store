...
<template>
  <footer class="app-footer">
    ...
    <div class="footer-links-section">
      <div class="footer-inner-content links-grid">
        <!-- Column 1 -->
...
.footer-bg-wrapper {
  ...
  /* The layout above it has a 240px sidebar + 15px gap that we need to skip */
}
